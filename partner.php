...
if (isset($_POST['partner'])){
            $email = mysqli_real_escape_string($conn, $_POST['partner_email']);
            $password = mysqli_real_escape_string($conn, $_POST['partner_password']);
            ...
            if (count($errors) == 0) {
                ...
                $query = "SELECT * FROM partner WHERE partner_password = '$password', partner_email = '$email' ";
